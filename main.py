...
if answer in "да":
    text = f"""Привет Мама(Папа), я занимаюсь в школе третье место уже {time}. В процессе я выполнил модули: {completed_lessons}! Сейчас я работаю над модулями {in_progress_lessons}. Обучение мне нравится, я получил море знаний"""
elif answer in "нет":
    text = f""" Текст письма: "Привет Мама(Папа), я занимаюсь в школе третье место уже {time}. Сейчас я работаю над модулями {in_progress_lessons}. Пока что я улучшаю свои навыки и узнаю много нового!""""
else:
